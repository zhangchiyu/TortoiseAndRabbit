    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.bt_submit:
                ...
                if (NetUtils.isNetworkConnected(UpdatePasswordActivity.this)) {
                    TARService service = App.getInstance().getService();
                    pDialog.show();
                    service.resetPayPassword("resetPayPassword", App.userData.getSessionToken(), oldmd5String, newmd5String)
                            ...
                            .subscribe(new Subscriber<Result>() {
                                ...
                                public void onNext(Result result) {
                                    if (result.isSuccess()) {
                                        if (result.isSuccess()){
                                            SharedPreferencesUtil.changeSp("baoxian",newPassword);
                                            SharedPreferencesUtil.changeSp("setbaoxian","true");
                                        }else{
